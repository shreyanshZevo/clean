...
router.post("/products", controller.onCreateProduct.bind(controller)); // why we are using .bind(controller)
router.get("/products", controller.onGetProducts.bind(controller));
router.put("/products", controller.onUpdateProduct.bind(controller));
router.delete(
  "/deleteProduct/:id",
